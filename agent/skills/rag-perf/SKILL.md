...
license: "Apache-2.0"
metadata: {"tool-version":"0.1.0","author":"NVIDIA RAG <foundational-rag-dev@exchange.nvidia.com>","github-url":"https://github.com/NVIDIA-AI-Blueprints/rag","argument-hint":"rag-perf | aiperf | TTFT | latency | throughput | concurrency sweep | bottleneck | retrieval / reranker tuning | profile-only | synthetic queries | quick_profile.yaml | single_run.yaml | sweep.yaml | uv run --project scripts/rag-perf","domain":"ai-ml"}
---
