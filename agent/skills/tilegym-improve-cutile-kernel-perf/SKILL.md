...
metadata: {"author":"TileGym Team <TileGym@nvidia.com>","version":"2026.4.11","environment":"IDE: Claude Code, Cursor (Agent mode); model: Opus 4.6","requires":"GPU node Blackwell, Hopper and Ampere for benchmarking"}
---
