...
license: "Apache-2.0"
metadata: {"author":"NVIDIA RAG <foundational-rag-dev@exchange.nvidia.com>","github-url":"https://github.com/NVIDIA-AI-Blueprints/rag","argument-hint":"RAGAS eval | evaluate_rag | train.json | corpus | results json | error triage | uv run --project scripts/eval | enable_reranker | query_rewriting | temperature | skip_ingestion","domain":"ai-ml"}
---
