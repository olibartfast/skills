...
license: "Apache-2.0"
metadata: {"author":"NVIDIA Physical AI","upstream_clone_path":"${PHYSICAL_AI_SKILL_HUB_UPSTREAM_ROOT:-$HOME/.physical-ai-skill-hub/upstreams}/nurec-skills","upstream_override_env":"NUREC_SKILLS_UPSTREAM_ROOT"}
---
